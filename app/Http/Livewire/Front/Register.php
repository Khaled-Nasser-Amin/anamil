...
class Register extends Component
{
    ...
    public $name,$store_name,$email,$categories,$category,$whatsapp,$location,$phone,$password,$password_confirmation,$code,$geoLocation='';
    ...
    public function validation(){
      ...
      return  $this->validate([
        ...
        'location' => ['required',Rule::in($this->cities)],
