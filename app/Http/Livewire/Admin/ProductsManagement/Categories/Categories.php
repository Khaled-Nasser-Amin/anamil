...
class Categories extends Component
{
    ...
    public function edit($id){
        ...
        $this->slug=$cat->slug;
        $this->shipping_place=$cat->shipping_place;
        // $this->parent=$cat->parent_id;
        // $this->getCategoriesForUpdate($id);
        // $arr=collect($this->cateUpdate)->collapse();
        // $this->update_categories=Category::withTrashed()
        // ->whereNotIn('id',$arr)->where('id','!=',$cat->id)->pluck('id')->toArray();
    }
    ...
    public function render()
    {
        ...
        when($this->search,function ($q){
            ...
            ->where('name_ar','like','%'.$this->search.'%')
                ...
                ->orWhere('shipping_place','like','%'.$this->search.'%');
        })->paginate(10);
    ...
    public function validateData()
    {
       return $this->validate([
           ...
           'shipping_place' =>['required' , Rule::in(['in_city','anywhere'])],
