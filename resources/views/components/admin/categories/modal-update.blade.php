            ...
            <div class="modal-body">
                <form >
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="shipping_place1" class="control-label">{{__('text.Shipping place')}}</label>
                                <select wire:model="shipping_place" id="shipping_place1" class="form-control">
                                    <option value=""></option>
                                    <option value="in_city">@lang('text.In City')</option>
                                    <option value="anywhere">@lang('text.Anywhere')</option>
                                </select>
                                <x-general.input-error for="shipping_place" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
